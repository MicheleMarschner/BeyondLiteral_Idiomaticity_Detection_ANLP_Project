...
def apply_mask(
    ...
    if variant == "first":
        new_texts = [mask_first_occurrence(string, mwe, mask_token) for string, mwe in zip(texts, mwes)]
    elif variant == "last":
        new_texts = [mask_last_occurrence(string, mwe, mask_token) for string, mwe in zip(texts, mwes)]
    elif variant == "both":
        new_texts = [mask_all_occurrences(string, mwe, mask_token) for string, mwe in zip(texts, mwes)]
    elif variant == "both_n_mask":
        new_texts = [mask_all_occurrences_n_mask(string, mwe, mask_token) for string, mwe in zip(texts, mwes)]
    else:
